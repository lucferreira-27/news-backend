...
import com.example.newsbackend.entity.nlu.TextConcept;
import com.example.newsbackend.entity.nlu.TextEntity;
import com.example.newsbackend.entity.nlu.TextKeyword;
...
class ResultAnalysisServiceImplTest {
    ...
    @Mock
    private WatsonNLUServiceImpl mockWatsonNLUServiceImpl;
    @Mock
    ...
    void when_Analyze_Should_Return_StorageResult() throws Exception {
        ...
        when(mockWatsonNLUServiceImpl.startAnalysis(pageBodyContent)).thenReturn(jsonResponseExpected);
        ...
        verify(mockWatsonNLUServiceImpl, times(1)).startAnalysis(pageBodyContent);
    ...
    void when_Analyze_Should_Reuse_StorageResult_If_Found_Given_Url() throws Exception {
        ...
        verify(mockWatsonNLUServiceImpl, never()).startAnalysis(anyString());
    ...
    void if_Scrape_Failed_StorageStatus_Should_Be_Invalid_Query() throws Exception {
        ...
        verify(mockWatsonNLUServiceImpl, never()).startAnalysis(pageBodyContent);
